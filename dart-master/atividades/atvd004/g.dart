...
// O método where() não está definido diretamente para o tipo Map em Dart.
// É necessário converter o mapa para uma lista de pares chave/valor (MapEntry)
// usando o método entries, aplicar o método where() na lista resultante e,
// em seguida, converter de volta para um mapa usando o construtor fromEntries().
